...
GShader linemorph = new GShader("linemorph.frag");
  ...
  // middlediamond.frag
    // mathplot1.glsl FIRST
  GShader middlediamond = new GShader("middlediamond.frag");
  shaderList.add(middlediamond);
  middlediamond.parameters.add(new Param("FADER1",-0.5,5));
  middlediamond.parameters.add(new Param("FADER2",-0.5,5));
  middlediamond.parameters.add(new Param("FADER3",-0.5,5));
  middlediamond.parameters.add(new Param("FADER4",-0.5,5));
  middlediamond.parameters.add(new Param("FADER5",-0.5,5));
  middlediamond.parameters.add(new Param("FADER6",-0.5,5));
  middlediamond.parameters.add(new Param("FADER7",-0.5,5));
  middlediamond.parameters.add(new Param("FADER8",-0.5,5));
  middlediamond.parameters.add(new Param("FADER9",-0.5,5));
  middlediamond.parameters.add(new Param("FADER10",-0.5,5));
  middlediamond.parameters.add(new Param("FADER11",-0.5,5));
  middlediamond.parameters.add(new Param("FADER12",-0.5,5));
...
void initCurrentShader() {
  ...
  oscP5 = new OscP5(this, 4001); // INCOMING OSC PORT
